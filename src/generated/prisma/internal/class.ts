...
/**
  ...
  /**
   * `prisma.ar`: Exposes CRUD operations for the **ar** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Ars
    * const ars = await prisma.ar.findMany()
    * ```
    */
  get ar(): Prisma.arDelegate<ExtArgs, { omit: OmitOpts }>;
}
